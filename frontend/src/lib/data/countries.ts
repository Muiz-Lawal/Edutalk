...
export const findByCode = (code: string | undefined | null) =>
  COUNTRIES.find((country) => country.code.toLowerCase() === String(code || '').toLowerCase());

export const findByName = (name: string | undefined | null) =>
  COUNTRIES.find((country) => country.name.toLowerCase() === String(name || '').toLowerCase());
